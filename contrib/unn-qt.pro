...
RESOURCES += src/qt/unn.qrc src/qt/unn_locale.qrc

TRANSLATIONS += src/qt/locale/unn_bg.ts \
                src/qt/locale/unn_de.ts \
                src/qt/locale/unn_en.ts \
                src/qt/locale/unn_es.ts \
                src/qt/locale/unn_fi.ts \
                src/qt/locale/unn_fr.ts \
                src/qt/locale/unn_it.ts \
                src/qt/locale/unn_ja.ts \
                src/qt/locale/unn_pl.ts \
                src/qt/locale/unn_pt.ts \
                src/qt/locale/unn_ru.ts \
                src/qt/locale/unn_sk.ts \
                src/qt/locale/unn_sv.ts \
                src/qt/locale/unn_vi.ts \
                src/qt/locale/unn_zh_CN.ts \
                src/qt/locale/unn_zh_TW.ts
