...
This mechanism has been integrated into Bitcore-Node-UniNet which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/UniNet-Project/insight-api-unn#web-socket-api](https://github.com/UniNet-Project/insight-api-unn#web-socket-api) 
* API: [https://github.com/UniNet-Project/insight-api-unn#instantsend-transactions](https://github.com/UniNet-Project/insight-api-unn#instantsend-transactions) 
...
By default, the UniNet Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the UniNet Core daemon:
