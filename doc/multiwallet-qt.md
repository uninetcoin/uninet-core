...
In order to support loading of multiple wallets in unn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is unn.cpp.
...
Changes to unn.cpp
----------------------
unn.cpp is the entry point into unn-qt, and as such, will require some minor modifications to provide hooks for
