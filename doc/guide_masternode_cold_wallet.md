...
* 1000 UNN (https://crex24.com/exchange/UNN-BTC)
...
The basic reasoning for these requirements is that, you get to keep your UNN in your local wallet, and host your masternode remotely, securely.
...
3. RUN script bellow(select from below, COPY, PASTE in Putty and press ENTER):
   ...
   ```wget -qO- https://github.com/uninetcoin/uninet-core/releases/download/mn_installer/unn_mn_installer.sh | bash```
...
1. Go to https://uninet-coin.com/ and download wallet for your windows
2. Unpack it and launch ***unn-qt.exe***
3. Select "Use a custom data directory" and use D:\unn\data as folder
...
6. Send 1000 UNN to this address.(Make sure this is 100% only 1000; No less, no more.) and wait for 15 confirmations
...
8. Still on the main computer, go into the UniNet data directory(D:\unn\data)
   ...
   ***Substitute it with your own values and without the “<>”s***
   ...
   ```mn1 10.10.10.10:47578 5j31NEU4Mw629r9SQLiqctuAody3BL8E9tW3aQD7wR2bA2AzQhh e629899c90494cf2a0b8935bece819480db0749b59e0d65ffb55c9bffaed5f99 1```
   
9. Still on the main computer. in same folder , open the unn.conf file. Make it look like this:
