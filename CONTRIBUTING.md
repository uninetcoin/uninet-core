Contributing to UniNet Core
============================

The UniNet Core project operates an open contributor model where anyone is
...
The following applies to code changes to the UniNet Core project, and is not to be
confused with overall UniNet Network Protocol consensus changes.

Whether a pull request is merged into UniNet Core rests with the project merge
...
Patches that change UniNet consensus rules are considerably more involved than
...
Where a patch set proposes to change the UniNet consensus, it must have been
...
The project leader is the release manager for each UniNet Core release.
