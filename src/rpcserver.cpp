...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* UniNet features */
        {"unn", "masternode", &masternode, true, true, false},
        {"unn", "listmasternodes", &listmasternodes, true, true, false},
        {"unn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"unn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"unn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"unn", "masternodedebug", &masternodedebug, true, true, false},
        {"unn", "startmasternode", &startmasternode, true, true, false},
        {"unn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"unn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"unn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"unn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"unn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"unn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"unn", "mnbudget", &mnbudget, true, true, false},
        {"unn", "preparebudget", &preparebudget, true, true, false},
        {"unn", "submitbudget", &submitbudget, true, true, false},
        {"unn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"unn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"unn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"unn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"unn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"unn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"unn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"unn", "checkbudgets", &checkbudgets, true, true, false},
        {"unn", "mnsync", &mnsync, true, true, false},
        {"unn", "spork", &spork, true, true, false},
        {"unn", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"unn", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use unnd, or the -server option to unn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> unn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:47579/\n";
}
