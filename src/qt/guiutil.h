...
/** Utility functions used by the UniNet Qt UI.
 */
namespace GUIUtil
{
...
// Render UniNet addresses in monospace font
...
// Parse "unn:" URI into recipient object, return true on successful parsing
