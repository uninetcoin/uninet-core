                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("UniNet Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UniNet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and unn: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About UniNet Core"), this);
    aboutAction->setStatusTip(tr("Show information about UniNet Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for UniNet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UniNet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UniNet addresses"));
    ...
    openAction->setStatusTip(tr("Open a UniNet: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the UniNet Core help message to get a list with possible UniNet command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("UniNet Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to UniNet network", "", count));
}
...
{
    QString strTitle = tr("UniNet Core"); // default title
